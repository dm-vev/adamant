...
func init() {
	...
	world.RegisterItem(DiamondHorseArmour{})
	...
	world.RegisterItem(GoldenHorseArmour{})
	...
	world.RegisterItem(IronHorseArmour{})
	world.RegisterItem(LapisLazuli{})
	world.RegisterItem(Leather{})
	world.RegisterItem(LeatherHorseArmour{})
	...
	world.RegisterItem(SpawnEgg{Entity: "minecraft:cow"})
