...
const (
	...
	// LockInInventory prevents the stack from being removed from the player's inventory.
	LockInInventory
	// LockInSlot prevents the stack from being moved or removed from its current slot.
	LockInSlot
)
