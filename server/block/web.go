...
// Cobweb is a non-solid block that drastically slows entities passing through it.
// It is broken quickly with a sword or shears and drops string when broken without silk touch.
type Cobweb struct {
	empty
	transparent
}

// Web is an alias for Cobweb.
type Web = Cobweb
