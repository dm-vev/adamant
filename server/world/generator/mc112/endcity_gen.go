...
type endCityGenFunc func(b *endCityBuilder, g *End, depth int, parent *endCityPiece, offset *endCityPos, out *[]*endCityPiece, r *javaRand) bool

func (b *endCityBuilder) recursiveChildren(g *End, gen endCityGenFunc, depth int, parent *endCityPiece, offset *endCityPos, pieces *[]*endCityPiece, r *javaRand) bool {
	if depth > 8 {
		return false
	}
...
func endCityHouseTowerGenerator(b *endCityBuilder, g *End, depth int, parent *endCityPiece, offset *endCityPos, out *[]*endCityPiece, r *javaRand) bool {
	if depth > 8 {
		return false
	}
	attach := endCityPos{}
...
func endCityTowerGenerator(b *endCityBuilder, g *End, depth int, parent *endCityPiece, _ *endCityPos, out *[]*endCityPiece, r *javaRand) bool {
	rotation := parent.rot
...
func endCityTowerBridgeGenerator(b *endCityBuilder, g *End, depth int, parent *endCityPiece, _ *endCityPos, out *[]*endCityPiece, r *javaRand) bool {
	rotation := parent.rot
...
func endCityFatTowerGenerator(b *endCityBuilder, g *End, depth int, parent *endCityPiece, _ *endCityPos, out *[]*endCityPiece, r *javaRand) bool {
	rotation := parent.rot
...
func (g *End) endCityStartRand(chunkX, chunkZ int) *javaRand {
